...
const claro: ChainDef = {
  ...
  missions: [
    ...
    {
      id: 'claro.9', who: 'don_beto', title: 'Agua de lluvia',
      ask: 'Mientras el compost trabaja: construí el tanque de lluvia. Lo que plantes va a necesitar agua.',
      done: 'Agua que junta el techo y no sale de ninguna canilla.',
      goal: { k: 'state', test: { t: 'station', id: 'tanque', lvl: 1 } }, target: { to: 'station', id: 'tanque' },
      reward: { sem: 25, card: 'e:tanque' },
    },
    {
    ...
    {
      id: 'claro.11', who: 'ines', title: 'Las primeras nativas',
    ...
    {
      id: 'claro.13', who: 'ines', title: 'Mañana, otra vez',
      ask: 'Lo plantado necesita agua en dos días distintos. Volvé otro día y regá de nuevo.',
    ...
    {
      id: 'claro.14', who: 'ines', title: 'El vivero',
    ...
    {
      id: 'claro.15', who: 'ines', title: 'Plantines propios',
    ...
    {
      id: 'claro.17', who: 'ines', title: 'Que florezca',
