...
- [ ] F8.13 NEXT ART LEVERS (if user wants more): DepthOfField in fullscreen, selective photo-textured GLB hero assets (CC0, draco ~30KB each) for cabins/bridge, richer per-biome prop sets, ambient audio.
